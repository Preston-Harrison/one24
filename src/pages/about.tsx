			...
			<main className="w-2/3 mx-auto">
				...
				<div className="mx-auto w-1/2 text-center">
					...
					<div className="text-lg">
						...
						read, be present to the arts and music, allows us to be more mindful of
						ourselves and others.
						<br />
						<br />
						Foundationally, we believe that the Arts and Humanities enable us to be
						fully human.
					</div>
				</div>
				<div className="mx-auto w-1/2 mt-10 text-center">
					...
					<div className="text-lg">
						...
						literature wishing to curate and share ideas and content with like-minded
						people.
					</div>
				</div>
			</main>
